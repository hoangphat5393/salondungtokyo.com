        ...
        <div class="sidebar-wrapper">
            <nav class="mt-2">
                ...
                <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                    ...
                    @if ($user->admin_level == '99999' && $user->roles->contains('name', 'Administrator'))
                    ...
                    <li class="nav-item {{ in_array(Route::currentRouteName(), $route_active) ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin_menu.index') }}" class="nav-link {{ Route::currentRouteName() == 'admin_menu.index' ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-angle-right"></i>
                                    <p>Admin Menu</p>
                                </a>
                            </li>
