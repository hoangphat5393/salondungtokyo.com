...
@section('content')
    ...
    <div class="app-content">
        <div class="container-fluid">
            <form action="{{ $id ? route('admin.service-category.update', $id) : route('admin.service-category.store') }}" method="POST" id="frm-create-category" enctype="multipart/form-data">
                @if ($id)
                    @method('PUT')
                @endif
                @csrf
