            ...
            <td class="title">
                ...
                @if ($item->slug)
                    <div>
                        ...
                        <a style="color:#00C600;" class="text-break" target='_blank' href="{{ route('page', ['slug' => $item->slug]) }}">{{ route('page', ['slug' => $item->slug]) }}</a>
                    </div>
                    <div>
                        <b style="color:#777;">URL EN:</b>
                        <a style="color:#00C600;" class="text-break" target='_blank' href="{{ route('page', ['slug' => $item->slug], true, 'en') }}">{{ route('page', ['slug' => $item->slug], true, 'en') }}</a>
                    </div>
                @endif
            </td>
            <td class="text-center">
