                    ...
                    <div class="card card-primary card-outline mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column flex-lg-row justify-content-between">
                                ...
                                @include('backend.partials.button_delete', ['type' => 'recruitment'])
                            ...
                            <div class="d-flex justify-content-between align-items-center my-4">
                                <div>
                                    <b>@lang('admin.total')</b>: <span class="fw-bold text-red">{{ $total_item ?? 0 }}</span> @lang('admin.contact')
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered list-data v-center" id="table_index">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">@lang('admin.Contact')</th>
                                            <th class="text-center">@lang('admin.Apply position')</th>
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="row-title fw-bold" href="{{ route('admin.recruitment.edit', $item->id) }}">
                                                        {{ $item->name }}
                                                    </a>
                                                </td>
                                                <td>
                                                    Email: <a class="row-title fw-bold" href="mailto:{{ $item->email }}">
                                                        {{ $item->email }}
                                                    </a>
                                                    <br>
                                                    Phone:
                                                    <a class="row-title fw-bold" href="tel:{{ $item->phone }}">
                                                        {{ $item->phone }}
                                                    </a>
                                                </td>
                                                <td>
