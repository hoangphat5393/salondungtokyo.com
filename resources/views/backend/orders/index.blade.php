                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 mt-3">
                                    <a class="btn {{ request('cart_status') != '' ? 'btn-outline-primary' : 'btn-primary' }}" href="{{ url()->current() }}">Tất cả ({{ new \App\Models\Addtocard()->count() }})</a>
                                    @foreach ($statusOrder as $key => $item)
                                        @php
                                            $order_count = new \App\Models\Addtocard()->where('cart_status', $key)->count();
                                        @endphp
                                        ...
                                        @foreach ($data_order as $data)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="row-title" href="{{ route('admin.orderDetail', [$data->cart_id]) }}">
                                                        <b>{{ $data->cart_code }}</b>
                                                    </a>
                                                </td>
                                                <td class="text-center">
