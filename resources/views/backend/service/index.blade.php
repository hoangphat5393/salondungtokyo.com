                    ...
                    <div class="mb-4 card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column flex-lg-row justify-content-between">
                                @include('backend.partials.button_add_delete', ['type' => 'post', 'route' => route('admin.service.create')])
                            ...
                            <div class="my-4 d-flex justify-content-between align-items-center">
                                <div>
                                    <b>@lang('admin.total')</b>: <span class="fw-bold text-red">{{ $total_item ?? 0 }}</span> @lang('admin.service')
                                </div>
                            </div>
