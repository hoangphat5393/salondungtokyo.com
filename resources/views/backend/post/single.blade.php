...
@section('content')
    ...
    <div class="app-content">
        <div class="container-fluid">
            <form id="formEdit" action="{{ $form_action }}" method="POST" id="frm-create-post" enctype="multipart/form-data">
                @if (!request()->route()->named('admin.post.create'))
                    @method('PUT')
                @endif
                @csrf
                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="card card-warning card-outline mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="sort" class="form-label text-lg-right">@lang('Sort')</label>
                    ...
                    <div class="col-md-3">
                        ...
                        {{-- SELECT CATEGORY --}}
                        <div class="card widget-category mb-4">
                            <div class="card-header">
                            ...
                            <div class="card-body max-vh-75">
                                <div class="inside clear">
                                    @php
                                        $array_checked = isset($post) ? $post->categories->pluck('id')->toArray() : [];
                                        $category_type = 'post';
                                    @endphp
