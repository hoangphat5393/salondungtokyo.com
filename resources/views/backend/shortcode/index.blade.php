                    ...
                    <div class="card card-primary card-outline mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column flex-lg-row justify-content-between">
                                @include('backend.partials.button_add_delete', ['type' => 'shortcode', 'route' => route('admin.shortcodeCreate')])
                                <div>
                            ...
                            <div class="d-flex align-items-center justify-content-between my-4">
                                <div>
                                    <b>@lang('admin.total')</b>: <span class="fw-bold text-red">{{ $total_item ?? 0 }}</span> @lang('admin.shortcode')
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered list-data v-center" id="table_index">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="min-width:250px">@lang('admin.description')</th>
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="row-title fw-bold" href="{{ route('admin.shortcodeEdit', $item->id) }}">
                                                ...
                                                <td class="text-center">
                                                    <img src="{{ get_image($item->image) }}" style="height: 120px;">
                                                </td>
                                                {{-- <td class="text-center">
                                                    {{ $item->updated_at }}
                                                    <br>
