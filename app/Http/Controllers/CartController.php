...
use Cart, Auth; // 'vendor\Gloudemans\Shoppingcart\Facades'
...
class CartController extends Controller
{
    ...
    public function cart()
    {
        ...
        $this->data['states'] = \App\Models\Province::get();
    ...
    public function updateCarts()
    {
        ...
        return response()->json([
            ...
            'count_cart' => Cart::count(),
            'subtotal' => $subtotal,
            'view_cart_mini' => view($this->templatePath . '.cart.cart-mini')->render(), // header cart
            'view' => view($this->templatePath . '.cart.cart-list', compact('carts', 'variable_group'))->render(), // table cart
    ...
    {
        $this->localized();
        $this->data['cart'] = \App\Models\Addtocard::where('cart_id', $cart_id)->first();
        // dd($cart);
    ...
    public function checkoutProcess(Request $request)
    {
        ...
        $respons = \App\Models\Addtocard::create($database);

        $order_id = auto_code('Order', $respons->cart_id);
        $cart = \App\Models\Addtocard::where('cart_id', $respons->cart_id)->first();
        ...
        foreach ($cart_content as $key => $value) {
            ...
            \App\Models\Addtocard_Detail::create([
                'product_id' => $value['id'],
