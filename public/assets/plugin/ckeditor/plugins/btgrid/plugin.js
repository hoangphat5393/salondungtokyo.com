    ...
    CKEDITOR.plugins.add('btgrid', {
        ...
        init: function (editor) {
            ...
            editor.widgets.add('btgrid', {
                ...
                init: function () {
                    // if (this.data.layoutGrid) {
                    //     // Thêm các lớp tùy chỉnh vào template
                    //     this.parts.btgrid.addClass(this.data.layoutGrid);
                    // }
                    var rowNumber = 1;
                ...
                data: function () {
                    if (this.data.colCount && this.element.getChildCount() < 1) {
                        var layoutGrid = this.data.layoutGrid;
                        ...
                        // Add layoutGrid class
                        this.parts.btgrid.addClass(layoutGrid ?? 'container');
                    }
                },
                ...
                createGrid: function (colCount, row, rowNumber) {
                    ...
                    for (var i = 1; i <= colCount; i++) {
                        content = content + '<div class="col-md-' + maxGridColumns / colCount + '">' + '  <div class="content">' + '    <p>Col ' + i + ' content area</p>' + '  </div>' + '</div>';
                    }
                    content = content + '</div>';
