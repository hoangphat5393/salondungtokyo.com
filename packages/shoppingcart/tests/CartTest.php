...
use Surfsidemedia\Tests\Shoppingcart\Fixtures\BuyableProduct;
use Surfsidemedia\Tests\Shoppingcart\Fixtures\ProductModel;
...
class CartTest extends TestCase
{
     ...
     * @test
     *
     * @expectedException \Surfsidemedia\Shoppingcart\Exceptions\InvalidRowIDException
     */
     ...
     * @test
     *
     * @expectedException \Surfsidemedia\Shoppingcart\Exceptions\UnknownModelException
     *
    ...
    /** @test */
    public function it_can_return_cart_item_formated_numbers_by_config_values()
    {
        $this->setConfigFormat(2, ',', '');
